...
# Time Succes decompile : 2022-05-12 15:09:23.374535
...
\033[93;1m   ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ 
 \033[1;32m[\033[0;41;37m==========={ AUTHER 🔥\033[0;37;41m KING SOMRAT }===========\033[1;37;40m\033[1;32m] \033[1;37;40m     
  ╔══════════════════════════════════════════
  ║  Create :- MD SOMRAT HOSSAIN      	║       
  ║  TOOL :- OLD ID CRACK3		║
  ║  HACKER SOMRAT BRO       			  		    ║
  ║ GITHUB :- lonewolf-313   	    	   				  		 			 ║
  ╚══════════════════════════════════════════"""
...
class Main:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[ SOMRAT] : %s/%s -> \033[0;97m [OK:%s ] \033[0;97m[CP:%s ]"%(W,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
